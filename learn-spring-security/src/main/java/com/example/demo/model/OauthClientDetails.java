...
@Entity
@Table(name = "oauth_client_details", uniqueConstraints = {
		@javax.persistence.UniqueConstraint(columnNames = { "client_id" }) })
//@Data
public class OauthClientDetails {
	...
	public OauthClientDetails(String id, String client_id, String resource_ids, String client_secret, String scope,
